...
- [x] 07-03-PLAN.md — i18n packaging: Domain Path header, load_plugin_textdomain, wp_set_script_translations, PHP→JS i18n bridge (wp_add_inline_script + window.ddmmI18n), WP-CLI .pot generation
- [x] 07-04-PLAN.md — COMP-03 static verification (WC-agnostic by construction) + 07-HUMAN-UAT.md manual verification matrix for all live-behavior truths
